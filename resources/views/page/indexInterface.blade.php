...
<nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href={{action('ListThemeController@index')}}>List themes</a>
            </li>
        </ul>
    </div>
</nav>
    ...
    <div class="row">
        <main class="col">
            ...
            <div class="form-control">
                {!! Form::open(['action' => 'AdminController@index', 'class' => 'form-signin']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('Password', null, ['class' => 'form-control','placeholder' => 'Change Password', 'autofocus' => 'autofocus']) !!}
                    </div>
                <div class="form-group">
            ...
            <div class="form-control">
                <a href="{{action('CreateAdminController@index')}}" class="btn btn-success btn-lg btn-block">Create admin</a>
            </div>
        </main>
    </div>
</div>
